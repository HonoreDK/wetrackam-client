# WeTrackam Client v15 — application chauffeur
...
1. Déposer les deux fichiers Firebase officiels décrits dans
   `FIREBASE-ET-RECETTE.md` (ils ne sont volontairement pas inventés).
...
Dans cet environnement, Flutter/Dart et les secrets Firebase officiels sont
absents : aucun APK/IPA, push réel, appel audio, TURN ou test VPS n'est donc
